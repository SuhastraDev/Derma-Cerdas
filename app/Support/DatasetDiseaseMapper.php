...
class DatasetDiseaseMapper
{
    ...
    private const CLASS_GROUPS = [
        ...
        'Neurotic_Excoriations' => 'RARE_SPECIALIST_EDUCATION',
        'Nevus_Comedonicus' => 'BENIGN_LESION',
        'Nevus_Incipiens' => 'BENIGN_LESION',
        'Nevus_Sebaceous_of_Jadassohn' => 'BENIGN_LESION',
        'Nevus_Spilus' => 'BENIGN_LESION',
        'Nummular_Eczema' => 'DERMATITIS_ECZEMA',
        'Onychogryphosis' => 'HAIR_NAIL_EXCLUDE',
        'Onycholysis' => 'HAIR_NAIL_EXCLUDE',
        'Onychomycosis' => 'FUNGAL_REFER',
        'Onychoschizia' => 'HAIR_NAIL_EXCLUDE',
        'Paronychia' => 'BACTERIAL_INFECTIOUS_REFER',
        'Pearl_Penile_Papules' => 'BENIGN_LESION',
        'Perioral_Dermatitis' => 'RARE_SPECIALIST_EDUCATION',
        'Pincer_Nail_Syndrome' => 'HAIR_NAIL_EXCLUDE',
        'Pitted_Keratolysis' => 'RARE_SPECIALIST_EDUCATION',
        'Pityriasis_Alba' => 'PIGMENT_COSMETIC',
        'Pityriasis_Rosea' => 'RARE_SPECIALIST_EDUCATION',
        'Pityrosporum_Folliculitis' => 'FUNGAL_SUPERFICIAL',
        'Poikiloderma_Atrophicans_Vasculare' => 'RARE_SPECIALIST_EDUCATION',
        'Pomade_Acne' => 'ACNE_FOLLICULAR',
        'Pseudofolliculitis_Barbae' => 'ACNE_FOLLICULAR',
        'Pseudorhinophyma' => 'RARE_SPECIALIST_EDUCATION',
        'Psoriasis' => 'PSORIASIS_PAPULOSQUAMOUS',
        'Pustular_Psoriasis' => 'PSORIASIS_PAPULOSQUAMOUS',
        'Pyoderma_Gangrenosum' => 'AUTOIMMUNE_SYSTEMIC_REFER',
        'Pyogenic_Granuloma' => 'BENIGN_LESION',
        'Racquet_Nail' => 'HAIR_NAIL_EXCLUDE',
        'Radiodermatitis' => 'RARE_SPECIALIST_EDUCATION',
        'Rhinophyma' => 'RARE_SPECIALIST_EDUCATION',
        'Rosacea' => 'RARE_SPECIALIST_EDUCATION',
        'Scalp_Psoriasis' => 'PSORIASIS_PAPULOSQUAMOUS',
        'Scar' => 'BENIGN_LESION',
        'Scarring_Alopecia' => 'HAIR_NAIL_EXCLUDE',
        'Schamberg\'s_Disease' => 'RARE_SPECIALIST_EDUCATION',
        'Sebaceous_Gland_Hyperplasia' => 'BENIGN_LESION',
        'Seborrheic_Dermatitis' => 'DERMATITIS_ECZEMA',
        'Seborrheic_Keratosis' => 'BENIGN_LESION',
        'Skin_Tag' => 'BENIGN_LESION',
        'Solar_Lentigo' => 'PIGMENT_COSMETIC',
        'Stasis_Dermatitis' => 'RARE_SPECIALIST_EDUCATION',
        'Stasis_Edema' => 'RARE_SPECIALIST_EDUCATION',
        'Stasis_Ulcer' => 'BACTERIAL_INFECTIOUS_REFER',
        'Steroid_Acne' => 'RARE_SPECIALIST_EDUCATION',
        'Steroid_Striae' => 'PIGMENT_COSMETIC',
        'Steroid_Use_abusemisuse_Dermatitis' => 'RARE_SPECIALIST_EDUCATION',
        'Stomatitis' => 'BACTERIAL_INFECTIOUS_REFER',
        'Strawberry_Hemangioma' => 'BENIGN_LESION',
        'Striae' => 'PIGMENT_COSMETIC',
        'Subungual_Hematoma' => 'HAIR_NAIL_EXCLUDE',
        'Syringoma' => 'BENIGN_LESION',
        'Terry\'s_Nails' => 'HAIR_NAIL_EXCLUDE',
        'Tinea_Corporis' => 'FUNGAL_SUPERFICIAL',
        'Tinea_Cruris' => 'FUNGAL_SUPERFICIAL',
        'Tinea_Faciale' => 'FUNGAL_SUPERFICIAL',
        'Tinea_Manus' => 'FUNGAL_SUPERFICIAL',
        'Tinea_Pedis' => 'FUNGAL_SUPERFICIAL',
        'Tinea_Versicolor' => 'FUNGAL_SUPERFICIAL',
        'Toe_Deformity' => 'HAIR_NAIL_EXCLUDE',
        'Trichilemmal_Cyst' => 'BENIGN_LESION',
        'Trichofolliculoma' => 'BENIGN_LESION',
        'Trichostasis_Spinulosa' => 'HAIR_NAIL_EXCLUDE',
        'Ulcer' => 'BACTERIAL_INFECTIOUS_REFER',
        'Urticaria' => 'DERMATITIS_ECZEMA',
        'Varicella' => 'VIRAL_REFER',
        'Verruca_Vulgaris' => 'VIRAL_EDUCATION',
        'Vitiligo' => 'RARE_SPECIALIST_EDUCATION',
        'Wound_Infection' => 'BACTERIAL_INFECTIOUS_REFER',
