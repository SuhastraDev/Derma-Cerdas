...
class QuestionBank
{
     ...
     *
     * @return array<int, array{code: string, name: string, name_indonesian: string, dataset_class: string, dataset_class_id: int, default_action: string, description: string, medical_treatment_note?: string, source_note?: string}>
     */
    public static function diseases(): array
    {
        return [
            ...
            ['code' => 'PSORIASIS', 'name' => 'Psoriasis', 'name_indonesian' => 'Psoriasis', 'dataset_class' => 'Psoriasis', 'dataset_class_id' => 153, 'default_action' => 'educate_only', 'description' => 'Penyakit kulit kronis berupa plak tebal kemerahan dengan sisik putih keperakan.', 'medical_treatment_note' => 'Dokter biasanya memulai dari kortikosteroid topikal berkekuatan sedang-kuat atau analog vitamin D (calcipotriol), lalu mempertimbangkan fototerapi UVB pada kasus lebih luas. Kasus berat/luas dapat memerlukan terapi sistemik (metotreksat) atau biologik. Ini bukan target obat bebas terbatas karena butuh penilaian luas area dan pemantauan dokter.', 'source_note' => 'DermNet psoriasis treatment: https://dermnetnz.org/topics/psoriasis; AAD psoriasis treatment: https://www.aad.org/public/diseases/psoriasis/treatment'],
            ...
            ['code' => 'KELOID', 'name' => 'Keloid', 'name_indonesian' => 'Keloid', 'dataset_class' => 'Keloid', 'dataset_class_id' => 93, 'default_action' => 'educate_only', 'description' => 'Jaringan parut menonjol yang tumbuh melebihi batas luka asal, lazim pada kulit berpigmen gelap.', 'medical_treatment_note' => 'Bukan kondisi yang diobati dengan obat oles bebas. Penanganan dokter meliputi suntikan kortikosteroid ke dalam jaringan parut, lembar/gel silikon, terapi dingin (cryotherapy), laser, atau operasi pengangkatan - operasi saja berisiko keloid tumbuh kembali sehingga sering dikombinasikan dengan terapi lain.', 'source_note' => 'DermNet keloid and hypertrophic scar: https://dermnetnz.org/topics/keloid-and-hypertrophic-scar'],
        ...
        return [
            'P1_LOKASI' => [
                ...
                'options' => [
                    ...
                    'P1_KAKI' => ['Sela jari kaki atau telapak kaki', 'Khusus di antara jari-jari kaki atau bagian bawah telapak — bukan tungkai/betis, itu termasuk pilihan "Badan, punggung, tungkai, atau lengan" di bawah'],
                    ...
                    'P1_BADAN' => ['Badan, punggung, tungkai, atau lengan', 'Area tubuh yang luas dan tertutup pakaian, termasuk betis/tungkai kaki (bukan telapak atau sela jari). Kalau menyebar di banyak area, pilih yang paling luas atau paling mengganggu'],
            ...
            'P3_SISIK' => [
                ...
                'options' => [
                    ...
                    'P3_KERING' => ['Kering dan pecah-pecah, tanpa pola kotak-kotak', 'Kulit terasa kaku, retak, kadang perih — permukaannya tidak membentuk pola geometris besar. Kalau sudah terlihat pola kotak-kotak seperti sisik ikan, pilih opsi di bawah ini, bukan opsi ini'],
                    'P3_SISIKIKAN' => ['Sisik besar berbentuk kotak-kotak seperti sisik ikan', 'Pola geometris besar menyerupai sisik ikan, menutupi area kulit yang luas — kulit di sela-sela sisiknya juga terasa kering, tapi ciri utamanya adalah pola kotak-kotaknya, bukan sekadar kering'],
            ...
            'P4_RASA' => [
                ...
                'options' => [
                    'P4_GATAL' => ['Gatal', 'Ingin menggaruk, dari yang ringan sesekali sampai mengganggu tidur — pilih ini walau gatalnya cuma ringan, asal memang ada dorongan menggaruk'],
                    ...
                    'P4_TIDAKTERASA' => ['Tidak gatal dan tidak nyeri', 'Hanya terlihat atau terasa kering/kencang saja, tanpa dorongan menggaruk maupun rasa nyeri'],
