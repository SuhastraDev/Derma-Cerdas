...
class QuestionBank
{
    ...
    public static function diseases(): array
    {
        return [
            ...
            ['code' => 'ACNE_VULGARIS', 'name' => 'Acne Vulgaris', 'name_indonesian' => 'Jerawat', 'dataset_class' => 'Acne_Vulgaris', 'dataset_class_id' => 2, 'default_action' => 'educate_only', 'description' => 'Peradangan kelenjar minyak dengan komedo dan bintil bernanah.'],
            ['code' => 'ECZEMA', 'name' => 'Eczema', 'name_indonesian' => 'Eksim', 'dataset_class' => 'Eczema', 'dataset_class_id' => 55, 'default_action' => 'educate_only', 'description' => 'Peradangan kulit kronis yang gatal, kering, dan kambuh-kambuhan.'],
            ['code' => 'URTICARIA', 'name' => 'Urticaria', 'name_indonesian' => 'Biduran', 'dataset_class' => 'Urticaria', 'dataset_class_id' => 193, 'default_action' => 'educate_only', 'description' => 'Bentol gatal yang muncul dan hilang dalam hitungan jam serta dapat berpindah.'],
